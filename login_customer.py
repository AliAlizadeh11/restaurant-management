import AP4002_Group4.create_customer as create_customer
import smtplib
import random
...
class LoginCustomer:
    ...
    def check_validation_email_password(self, email, password):
        global count
        count = 0 
        if LoginCustomer.email == create_customer.CreateCustomer.email:
            if LoginCustomer.password == create_customer.CreateCustomer.password:
                pass
            else:
